        ...
        <div className="mock-login-fields" aria-label={isRegisterMode ? t('registerFields') : t('loginFields')}>
          {isRegisterMode ? (
            <label className="mock-login-input">
              ...
              <input name="username" type="text" placeholder={t('username')} autoComplete="username" minLength={3} required />
            </label>
          ) : null}

          <label className="mock-login-input">
            <span aria-hidden="true">✉</span>
            <input name="email" type="email" defaultValue={isRegisterMode ? '' : 'Stevie22@gmail.com'} placeholder={t('email')} autoComplete="email" required />
          </label>
