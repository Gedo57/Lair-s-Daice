    ...
    <section className='start-screen-ui lui-81a227a1'>
      ...
      <main className='start-hero lui-2c270ecc'>
        ...
        <div className='start-actions lui-beb9d69c'>
          <button className='start-image-button start-play-button lui-4bf92a4e' type="button" onClick={() => navigate(ROUTES.loading)}>
            {t('playNow')}
          </button>
          <button className="start-image-button start-login-button" type="button" onClick={() => navigate(ROUTES.login)}>
            {t('login')}
          </button>
        </div>
      </main>
