  ...
  return (
    <>
      <div className="matchmaking-profile">
        <img className="matchmaking-profile__avatar" src={`${asset}22f.png`} alt="" draggable="false" />
        <div className="matchmaking-profile__plate">
          <span className="matchmaking-profile__name">EMMA</span>
          <div className="matchmaking-profile__progressRow">
            <img className="matchmaking-profile__badge" src={'/assets/liars-dice/room-select/563.png'} alt="" draggable="false" />
            <span className="matchmaking-profile__badgeValue">23</span>
            <div className="matchmaking-profile__progressBar">
              <div className="matchmaking-profile__progressFill" />
            </div>
            <span className="matchmaking-profile__progressText">
              <span className="matchmaking-profile__progressCurrent">1,450</span>
              <span className="matchmaking-profile__progressRest">/ 2,500</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="matchmaking-currency matchmaking-currency--coins">
        ...
        <span className="matchmaking-currency__value">125,680</span>
      ...
      <div className="matchmaking-currency matchmaking-currency--gems">
        ...
        <span className="matchmaking-currency__value">2,350</span>
        <img className="matchmaking-currency__plus" src={`${asset}88.png`} alt="" draggable="false" />
      </div>
    </>
  );
...
function PlayerSlot({ className = '', avatar, title, subtitle, caption }) {
  return (
    <div className={`matchmaking-slot ${className}`}>
      ...
      <div className="matchmaking-slot__inner">
        ...
        <span className="matchmaking-slot__title">{title}</span>
        {subtitle ? <span className="matchmaking-slot__subtitle">{subtitle}</span> : null}
...
export default function Matchmaking({ navigation }) {
  return (
    <section className="screen matchmaking-screen" aria-label="Matchmaking">
      ...
      <div className="matchmaking-panel">
        ...
        <div className="matchmaking-filters">
          {filters.map((item) => (
            <div className="matchmaking-filter" key={item.label}>
              <img className="matchmaking-filter__icon" src={`${asset}${item.icon}`} alt="" draggable="false" />
              <span className="matchmaking-filter__label">{item.label}</span>
              <span className="matchmaking-filter__value">{item.value}</span>
            </div>
          ))}

          <div className="matchmaking-signal">
            <img className="matchmaking-signal__icon" src={`${asset}6.png`} alt="" draggable="false" />
            <span className="matchmaking-signal__title">EXCELLENT</span>
        ...
        <div className="matchmaking-center">
          ...
          <span className="matchmaking-center__title">FINDING OPPONENTS</span>
          <span className="matchmaking-center__copy">Looking for players with similar stakes and skill</span>
        ...
        <PlayerSlot className="matchmaking-slot--left-top" avatar="22f.png" title="EMMA" subtitle="YOU" />
        <PlayerSlot className="matchmaking-slot--left-bottom matchmaking-slot--searching" avatar="ic2.png" title="Searching..." caption="••••" />
        <PlayerSlot className="matchmaking-slot--right-top" avatar="222.png" title="Dragon" subtitle="25k / 50k" />
        <PlayerSlot className="matchmaking-slot--right-bottom matchmaking-slot--searching" avatar="ic2.png" title="Searching..." caption="••••" />

        <div className="matchmaking-metrics">
          {metrics.map((item) => (
            <div className={`matchmaking-metric matchmaking-metric--${item.type}`} key={item.label}>
              <div className="matchmaking-metric__head">
                ...
                <span className="matchmaking-metric__label">{item.label}</span>
              </div>
              {item.type === 'quality' ? (
              ...
              <span className="matchmaking-metric__value">{item.value}</span>
            </div>
          ))}
        </div>
        ...
        <div className="matchmaking-steps">
          {steps.map((step, index) => (
            <div className="matchmaking-step" key={step.text}>
              ...
              <span className="matchmaking-step__text">{step.text}</span>
      ...
      <button className="matchmaking-action matchmaking-action--keep" type="button" onClick={navigation.goGameplay}>
        <img className="matchmaking-action__skin" src={'/assets/liars-dice/room-select/bottom-play.png'} alt="" draggable="false" />
        <span className="matchmaking-action__title">KEEP SEARCHING</span>
        <span className="matchmaking-action__subtitle">We'll find you the best table</span>
      </button>

      <button className="matchmaking-action matchmaking-action--cancel" type="button" onClick={navigation.goRoomSelect}>
        <img className="matchmaking-action__skin" src={`${asset}b1.png`} alt="" draggable="false" />
        <span className="matchmaking-action__title">CANCEL</span>
      </button>
    </section>
  );
}
