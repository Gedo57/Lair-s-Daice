...
export const mockRoomList = [
  { id: 'beginner_room', name: 'Beginner Room', bet: '100 coins', status: 'Available', maxPlayers: 4 },
  { id: 'classic_room', name: 'Classic Room', bet: '500 coins', status: 'Available', maxPlayers: 4 },
  { id: 'expert_room', name: 'Expert Room', bet: '1,000 coins', status: 'Locked placeholder', maxPlayers: 4 },
];
